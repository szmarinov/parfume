			...
			<div class="rh-container clearfix">
				<div class="footer_most_bottom mobilecenterdisplay mobilepadding">
					<div class="f_text font80">
						<span class="f_text_span mobmb10"><?php echo do_shortcode(rehub_option('rehub_footer_text')); ?></span>
	...
	<?php if(is_numeric($footer_template)):?>
		<div class="footer_clean_style post clearfix mb0"> 
			<?php if(function_exists('gspb_template_shortcode_function')):?>
				<?php echo gspb_template_shortcode_function(array('id' => $footer_template));?>
			<?php else:?>

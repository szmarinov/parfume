...
$term_name = $term->name;
$term_description = term_description($term_id, 'season');
?>

<div class="parfume-taxonomy season-taxonomy">
    ...
    <div class="taxonomy-content">
        <?php if (have_posts()): ?>
            ...
            <div class="season-filters">
                <?php echo do_shortcode('[parfume_filters show_season="false"]'); ?>
            </div>
        ...
        <?php else: ?>
            <p><?php _e('No perfumes found for this season.', 'parfume-reviews'); ?></p>
        <?php endif; ?>
    </div>
</div>
